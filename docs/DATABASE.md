...
>
> **Вимикач.** Реквізити продавця і є прапорцем вмикання: поки не заповнені `seller_name` і `seller_iban`,
...
> нічого не виставляє, доки хтось свідомо не заповнить реквізити.
>
