...
│   ├── test/                        # 946 tests across 82 test files
...
**946 integration tests** across 82 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
