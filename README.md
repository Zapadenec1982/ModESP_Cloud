...
[![Tests](https://img.shields.io/badge/Tests-902-brightgreen)](backend/test)
...
│   ├── test/                        # 935 tests across 80 test files
...
**935 integration tests** across 80 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
