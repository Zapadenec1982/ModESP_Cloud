...
│   ├── test/                        # 906 tests across 76 test files
...
**906 integration tests** across 76 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
