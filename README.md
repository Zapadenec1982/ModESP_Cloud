...
- **Push-сповіщення** — FCM + Telegram Bot (аварії, зняття аварій, офлайн пристрої)
...
- **Telegram Bot** — авторизація, RBAC, i18n (UA/EN), persistent keyboard, інтерактивні пристрої
- **i18n** — українська та англійська мови (WebUI + Telegram Bot)
...
│   │   │   ├── telegram.js       # Telegram Bot (i18n, RBAC, persistent keyboard)
...
│   │       └── migrations/       # 002–012 (інкрементальні)
│   ├── scripts/
...
# Міграції (виконати нові, якщо ще не застосовані)
...
**Фаза 8c (Telegram Bot Redesign) — повністю завершена ✅**
...
| 4 | Auth, User Management, Dynamic MQTT Auth | ✅ |
| 5 | History & Analytics (Telemetry, Alarm Stats) | ✅ |
| 6 | Fleet OTA (Upload, Deploy, Rollout) | ✅ |
| 6.5 | WebUI Polish (i18n, Theme, Metadata) | ✅ |
| 7 | Per-Device RBAC, Scalability, Frontend RBAC, OTA Board | ✅ |
| 8a | Tenant Management (superadmin, CRUD, reassign) | ✅ |
| 8b | Multi-Tenant Users (M:N, tenant picker, switcher) | ✅ |
| 8c | Telegram Bot Redesign (auth, RBAC, i18n, UX) | ✅ |
| — | VPS Deployment | ✅ Production |

**Наступні фази:** Bulk Device Import (9a), REST API + OpenAPI для ERP (9b), Advanced Analytics (10).
...
- 2026-03-09 — Phase 4 completion: Dynamic MQTT Auth, TLS deployment.
- 2026-03-09 — Phase 8a: Tenant Management, Phase 8b: Multi-Tenant Users.
- 2026-03-10 — MQTT Auth Hardening, bugfix session (go-auth cache, credential rotation).
- 2026-03-11 — Phase 8c: Telegram Bot Redesign (user auth, RBAC, i18n UA/EN, persistent keyboard, interactive devices, location in notifications, superadmin cross-tenant bypass).
