...
[![Tests](https://img.shields.io/badge/Tests-886-brightgreen)](backend/test)
...
│   ├── test/                        # 886 tests across 74 test files
...
**886 integration tests** across 74 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
