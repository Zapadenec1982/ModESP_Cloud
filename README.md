...
[![Tests](https://img.shields.io/badge/Tests-868-brightgreen)](backend/test)
...
│   ├── test/                        # 868 tests across 72 test files
...
**868 integration tests** across 72 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
