...
[![Tests](https://img.shields.io/badge/Tests-782-brightgreen)](backend/test)
...
│   ├── test/                        # 782 tests across 62 test files
...
**782 integration tests** across 62 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
