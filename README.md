...
│   ├── test/                        # 955 tests across 83 test files
...
**955 integration tests** across 83 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
