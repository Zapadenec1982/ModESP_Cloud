...
[![Tests](https://img.shields.io/badge/Tests-709-brightgreen)](backend/test)
...
│   ├── test/                        # 709 tests across 52 test files
...
**709 integration tests** across 52 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
...
| 10 | Test Infrastructure (Vitest, 709 tests, 52 test suites) | ✅ Complete |
...
- 709 integration tests against real PostgreSQL (not mocks)
