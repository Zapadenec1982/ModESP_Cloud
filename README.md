...
[![Tests](https://img.shields.io/badge/Tests-885-brightgreen)](backend/test)
...
│   ├── test/                        # 885 tests across 74 test files
...
**885 integration tests** across 74 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
