...
[![Tests](https://img.shields.io/badge/Tests-752-brightgreen)](backend/test)
...
│   ├── test/                        # 752 tests across 59 test files
...
**752 integration tests** across 59 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
...
| 10 | Test Infrastructure (Vitest, 752 tests, 59 test suites) | ✅ Complete |
