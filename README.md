...
[![Tests](https://img.shields.io/badge/Tests-899-brightgreen)](backend/test)
...
│   ├── test/                        # 899 tests across 75 test files
...
**899 integration tests** across 75 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
