...
[![Tests](https://img.shields.io/badge/Tests-663-brightgreen)](backend/test)
...
│   ├── test/                        # 663 tests across 43 test files
...
**663 integration tests** across 43 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
...
| 10 | Test Infrastructure (Vitest, 663 tests, 43 test suites) | ✅ Complete |
...
- 663 integration tests against real PostgreSQL (not mocks)
