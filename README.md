...
│   ├── test/                        # 941 tests across 81 test files
...
**941 integration tests** across 81 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
