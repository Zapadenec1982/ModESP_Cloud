...
[![Tests](https://img.shields.io/badge/Tests-604-brightgreen)](backend/test)
...
│   ├── test/                        # 604 tests across 34 test files
...
**604 integration tests** across 34 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
...
| 10 | Test Infrastructure (Vitest, 604 tests, 34 test suites) | ✅ Complete |
...
- 604 integration tests against real PostgreSQL (not mocks)
