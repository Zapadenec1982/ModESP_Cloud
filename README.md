...
[![Tests](https://img.shields.io/badge/Tests-632-brightgreen)](backend/test)
...
│   ├── test/                        # 632 tests across 37 test files
...
**632 integration tests** across 37 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
...
| 10 | Test Infrastructure (Vitest, 632 tests, 37 test suites) | ✅ Complete |
...
- 632 integration tests against real PostgreSQL (not mocks)
