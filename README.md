...
[![Tests](https://img.shields.io/badge/Tests-651-brightgreen)](backend/test)
...
│   ├── test/                        # 651 tests across 40 test files
...
**651 integration tests** across 40 test suites, powered by **Vitest + Supertest** against a real PostgreSQL instance (counts below are per area, approximate):
...
| 10 | Test Infrastructure (Vitest, 651 tests, 40 test suites) | ✅ Complete |
...
- 651 integration tests against real PostgreSQL (not mocks)
