...
module.exports = function register({ z, registry, uuid, isoDate, mqttId, listOf, errorOf, withCommon, PaginationMeta }) {
  const Report = registry.register('Report', z.object({
    ...
    report_type: z.enum(['haccp', 'alarms', 'energy', 'service']).openapi({ description: '`service` is the technician\'s PDF, generated by hand rather than by a schedule' }),
  ...
  registry.registerPath({
    ...
    request: { query: z.object({
      type: z.enum(['haccp', 'alarms', 'energy', 'service']).optional(), site_id: uuid.optional(),
